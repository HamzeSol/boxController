...
;CodeVisionAVR C Compiler V4.00 
...
;DATA STACK POINTER INITIALIZATION
	...
	#endif
;void delay(unsigned int _val)
; 0000 001F {

	.CSEG
; 0000 0020 unsigned int i=0;
; 0000 0021 for(_val=0;_val<1000;_val++)
;	_val -> R18,R19
;	i -> R16,R17
; 0000 0022 {
; 0000 0023 for(i=0;i<100;i++);
; 0000 0024 }
; 0000 0025 }
;void main(void)
; 0000 0027 {
...
; 0000 0032 // Function: Bit7=In Bit6=In Bit5=In Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0033 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (1<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(16)
	OUT  0x17,R30
; 0000 0034 // State: Bit7=T Bit6=T Bit5=T Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0041 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	OUT  0x12,R30
; 0000 0042 
; 0000 0043 // PORTD bit 5 High Drive enabled: Off
; 0000 0044 // PORTD bit 6 High Drive enabled: Off
; 0000 0045 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0046 //HDR=(0<<HDR5) | (0<<HDR4) | (0<<HDR3) | (0<<HDR2) | (0<<HDR1) | (0<<HDR0);
; 0000 0047 
...
; 0000 0098 PORTD=0b00010000;
	LDI  R30,LOW(16)
	RCALL SUBOPT_0x0
; 0000 0099 delay_ms(500);
; 0000 009A PORTD=0b00000000;
	LDI  R30,LOW(0)
	RCALL SUBOPT_0x0
